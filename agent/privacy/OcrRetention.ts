...
export class OcrRetention{
  private snapshot: OcrSnapshot | undefined = undefined;
  ...
  get():string|undefined{if(!this.snapshot)return;if(this.snapshot.expiresAt<=Date.now()){this.snapshot=undefined;return;}return this.snapshot.text;}
